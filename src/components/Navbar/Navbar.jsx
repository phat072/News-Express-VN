    ...
    return (
        <div className={style.NavbarMainDiv}>
            <ul className={style.NavLinks}>
                <li>
                    <label><FontAwesomeIcon icon={faHome}/></label>
                </li>
                <li style={{marginLeft : "50px"}}>
                    <Link to="/" rel="noreferrer">Thời sự</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Góc nhìn</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Thế giới</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">VIideo</Link>
                </li>
                <li>
                    <Link to="/podcast" rel="noreferrer">Podcasts</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Kinh doanh</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Bất động sản</Link>
                </li>
                <li>
                    <Link to="/Education" rel="noreferrer">Khoa hoc</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Giải trí</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Thể thao</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Pháp luật</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Giáo dục</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Sức khỏe</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Đời sống</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Du lịch</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Số hóa </Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Xe</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Ý kiến</Link>
                </li>
                <li>
                    <Link to="/" rel="noreferrer">Tâm sự</Link>
                </li>
                <li>
                    <a href="/" rel="noreferrer">Thư giãn</a>
                </li>
                    <div className={style.MenuIconBtn} style={{marginLeft :"15px"}}>
                        <Button
                            onClick={onOpen}
                            icon={<HamburgerIcon/>}
                            as={IconButton}
                                    ...
                                    <div className={style.MenuContainer}>
                                        <div className={style.MenuFirstDiv}>
                                            <ul className={style.ForAllUls}>
                                                <li className={style.BlockLi} style={{
                                                    fontSize: "20px",
                                                    fontWeight: "bold",
                                                    color: "#000",
                                                    width: "100%",
