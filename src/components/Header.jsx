...
import bg_header from '../assets/core-img/header-bg.jpg'
import logo from '../assets/core-img/logo.svg'
import aver_image from '../assets/core-img/logo.svg'
...
export const Header = () =>  {
    ...
    return (
        <div>
            ...
            <div style={{ backgroundImage: `url(${bg_header})`, backgroundSize: 'cover' }}>
                    ...
                    <div className='flex justify-center items-center flex-wrap'>
                        ...
                        <div className='md:w-8/12 w-full hidden md:block'>
                            <div className='w-full flex justify-end'>
                                <img src={aver_image}  alt="Aver Image" width={200} height={200}/>
                            </div>
                        </div>
